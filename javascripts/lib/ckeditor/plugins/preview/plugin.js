		...
		exec: function( editor ) {
			...
			if ( config.fullPage )
				...
				var css = [
					...
					window.location.origin + "/layoutmanager-ckeditor/css/lib/magicsuggest-min.css",
					window.location.origin + "/layoutmanager-ckeditor/css/app.css",
					"span.edit {display:none};span.remove {display:none}"
				];
				var js = [
					 "https://code.jquery.com/jquery-2.2.0.min.js",
					 "https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/javascripts/bootstrap.min.js",
					  window.location.origin +"/layoutmanager-ckeditor/javascripts/lib/magicsuggest-min.js"
				];
