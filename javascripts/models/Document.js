    ...
    function (Radio, Base, Textarea, Span) {
        ...
        var DocumentReadOnly = Base.extend({
            ...
            initialize: function(attrs, options) {
                ...
                this.type_id.pinValue =  Base.prototype.getPinValue.call(null,options.PIN.value + ".TYPE_ID") ;
                this.set("type_id", this.type_id);

                this.docname = _.clone(this.get("docname"));
                this.docname.pinValue =  Base.prototype.getPinValue.call(null,options.PIN.value + ".DOCNAME" );
                ...
                this.docnum.pinValue = Base.prototype.getPinValue.call(null, options.PIN.value + ".DOCNUM") ;
                ...
                this.tipo_protocollazione.pinValue =  Base.prototype.getPinValue.call(null,options.PIN.value + ".TIPO_PROTOCOLLAZIONE") ;
                ...
                this.abstract.pinValue = Base.prototype.getPinValue.call(null, options.PIN.value + ".ABSTRACT");
